    ...
    <Layout>
      <div className="content settings-page" data-theme={theme}>
        ...
        <div className="delete-profile_container">
          ...
          <button onClick={authData.sub !== import.meta.env.VITE_GUEST_ID ? () => deleteAccount() : console.log("Can't delete guest account")}><FormattedMessage id="account-delete_button" defaultMessage="Delete my account" /></button>
        </div>
      </div>
    </Layout>
  )
