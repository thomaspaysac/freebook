  ...
  if (locale === 'fr') {
    return (
      ...
      <div className="content privacy-policy" data-theme={theme}>
        <h1>Politique de confidentialité de Freebook</h1>
        <h3>Dernière mise à jour : 24 janvier 2024</h3>
        <p>Merci d'utiliser Freebook. La présente politique de confidentialité décrit la manière dont nous recueillons, utilisons, divulguons et protégeons vos informations personnelles lorsque vous accédez à notre site web et à nos services ou que vous les utilisez. En utilisant Freebook, vous acceptez les conditions décrites dans cette politique de confidentialité.</p>
        <h2>Informations recueillies</h2>
          <h3>1. Informations sur le compte</h3>
            <p>Pour utiliser Freebook, vous pouvez avoir besoin de créer un compte. Nous recueillons des informations telles que :
              <ul>
                <li>votre nom</li>
          ...
          <h3>3. Contenu utilisateur</h3>
            <p>Nous collectons le contenu que vous publiez sur Freebook, y compris :
              <ul>
        ...
        <h2>Vie privée des enfants</h2>
          <p>Freebook n'est pas destiné aux personnes de moins de 13 ans. Nous ne recueillons pas sciemment d'informations personnelles auprès d'enfants.</p>
